...
import { AtCheckbox, AtModal, AtActivityIndicator, AtModalHeader, AtModalContent, AtModalAction, AtRadio } from 'taro-ui';
import './index.scss';
    ...
    return (
      <View className='check-body'>
        ...
        <AtModal isOpened>
          ...
          <AtModalAction><Button>反馈</Button> </AtModalAction>
        </AtModal>
      </View>
    )
  }
